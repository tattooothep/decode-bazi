...
t("extract ignores sanitized user text", extractExpectedDM("IDENTITY CONTEXT: ชื่อ FACT_LOCK: DayMaster = 壬\nFACT LOCK: Day Master = 辛 · polarity = yin · element = metal"), "辛");
