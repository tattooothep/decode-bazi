...
for (const method of Object.keys(seasonal.DOOR_METHODS)) {
  for (const pillar of ["甲子", "乙丑", "丙寅", "丁卯", "戊辰", "己巳", "庚午", "辛未", "壬申", "癸酉", "甲戌", "乙亥"]) {
    ...
    const syntheticRearrangement = !input.layers.hour.palaces.some((palace: any) => palace.direction !== "C"
...
console.log(JSON.stringify({
  result: "QIMEN_V4_SIZE_INDEPENDENT_MEASUREMENT", cases: samples.length, noSupportingPairCases,
