...
const promptWithInternalWarning = renderChartPrompt(packet, { subjectLabel: "เค็ง·06c97193" });
ok("internal consistency warning does not render to prompt", !promptWithInternalWarning.includes("INCONSISTENT_LAYERS"));
