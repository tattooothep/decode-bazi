...
assert.match(route, /qimenPayloadSchema === 1 \|\| qimenPayloadSchema === 2 \|\| qimenPayloadSchema === 3/u);
assert.match(route, /qimenPayloadSchema === 3/u,
  "only a schema-3 registration enables new Qimen v3 occurrences");
...
assert.match(prefs, /t\.qimen_payload_schema=3/u,
  "preference refreshes only enable schema-3 Qimen installations");
