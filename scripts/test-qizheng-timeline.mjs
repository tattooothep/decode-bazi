...
ok("notAvailable ยังแจ้ง 流日/小限 ตามจริง (化曜 supplied แล้วผ่าน data.huaYao)", packet.notAvailable.includes("流日") && packet.notAvailable.includes("小限") && !packet.notAvailable.includes("化曜") && !!packet.data.huaYao);
