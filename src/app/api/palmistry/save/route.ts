...
export async function POST(req: NextRequest) {
  ...
  let body: { lang?: string; reading?: unknown; clarity?: number; engine?: string };
  ...
  try {
    const row = await q1<{ id: string }>(
      `INSERT INTO palm_readings (user_id, org_id, lang, reading, clarity, engine)
       VALUES ($1, $2, $3, $4::jsonb, $5, $6) RETURNING id`,
      [sess.userId, sess.orgId ?? null, lang, JSON.stringify(body.reading), clarity, body.engine ?? null]
    );
