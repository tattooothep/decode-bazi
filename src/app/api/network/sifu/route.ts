...
/* 24 ก.ค. 2569 · เดิมมีคำว่า "ใครต้องระวัง" ซึ่งชี้ไปที่ตัวบุคคล = ชนกฎกันคดีของเราเอง
 * (ห้ามจัดอันดับคน ห้ามป้ายแนวประเมินตัวคน) → เปลี่ยนเป็นพูดถึง "จุดของงาน" แทน
 * ถ้อยคำชุดเดียวกับที่เจ้านายเคาะให้เส้น team-matrix (พูดถึงคู่/งาน ไม่ตัดสินตัวคน) */
const TEAM_FOCUS = "ภาพรวมทีม · จุดแข็ง · จุดที่ต้องคุม · ใครเสริมใคร · คู่ไหนควรมีคนที่สามช่วยกลาง · ธาตุที่ขาด";
