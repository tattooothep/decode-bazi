...
export async function GET(_req: Request, ctx: Ctx) {
  ...
  return NextResponse.json({
    snapshot: {
      ...
      dayBoundary: row.day_boundary === "00:00" || row.day_boundary === "23:00" ? row.day_boundary : null,
      day_boundary: row.day_boundary === "00:00" || row.day_boundary === "23:00" ? row.day_boundary : null,
