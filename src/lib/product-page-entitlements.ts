/**
 * Hourkey entitlement contract v2.
 *
...
export const PRODUCT_CONTRACT_VERSION = "entitlements-v2-20260710";
...
export type ProductPageEntitlements = {
  ...
  luopan: { mode: "core" | "pro" | "full"; pins: "basic" | "full"; vision: boolean; sifu: boolean };
...
export const PRODUCT_PAGE_ENTITLEMENTS: Record<ProductPlan, ProductPageEntitlements> = {
  free: {
    ...
    luopan: { mode: "core", pins: "basic", vision: false, sifu: false },
  ...
  trial: {
    ...
    luopan: { mode: "core", pins: "basic", vision: true, sifu: false },
    palmistry: samePalmistry,
  },
  premium: {
    ...
    luopan: { mode: "pro", pins: "full", vision: true, sifu: true },
    palmistry: samePalmistry,
  },
  master: {
    ...
    luopan: { mode: "full", pins: "full", vision: true, sifu: true },
    palmistry: samePalmistry,
  },
};
