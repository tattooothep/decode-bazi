...
export const SIFU_SOURCE_DESCRIPTORS: SifuSourceDescriptor[] = [
  ...
  },
  {
    ...
    promptLabel: "📜 窮通寶鑑 · 調候用神/月令 ตัวบทจริง canonical (admin library id 13 · 10干×12เดือน · source of truth ชั้นร้อนเย็นแห้งชื้น; raw packet เป็น evidence)",
    authorityBook: "bazi-authority-tiaohou-yongshen",
  ...
  },
  {
    ...
    promptLabel: "📘 窮通寶鑑 · Thai teaching notes จาก memo id 13 (ชั้นอธิบาย 調候/月令 เป็นไทย · ใช้เสริม canonical; ห้ามชนะตัวบทจริง)",
    authorityBook: "bazi-authority-tiaohou-yongshen",
    routeInclusion: { sifuSingleFull: true, sifuGroupFull: true, codexCompact: false },
