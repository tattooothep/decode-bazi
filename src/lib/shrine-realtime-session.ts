...
function parseClientSecret(
  ...
  if (
    ...
    /*
     * 🔴 4 ส.ค. 69: ขอบเดิม +600 คือ "พอดีเป๊ะ" ไม่มีระยะเผื่อเลย
     * ผู้ให้บริการออกตั๋วอายุ 600 วินาทีพอดี ถ้านาฬิกาเครื่องเรา
     * ช้ากว่าเขาแม้แต่วินาทีเดียว ตั๋วทุกใบจะถูกตีตกเงียบๆ
     * = เสียงดับทั้งระบบโดยไม่มีใครรู้สาเหตุ
     * เผื่อไว้ 1 นาที ยังกันตั๋วอายุยาวผิดปกติได้เหมือนเดิม
     */
