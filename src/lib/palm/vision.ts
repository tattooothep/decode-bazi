...
const GROK_TIMEOUT = Math.max(30_000, Number(process.env.PALM_GROK_TIMEOUT_MS || 150_000)); // grok timeout สั้นกว่า route maxDuration 240s → เหลือเวลา fallback gemini/codex
