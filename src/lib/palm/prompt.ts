...
const CANON_FILES = [
  ...
  "11-chinese-verbatim-v1.md",
  "20-indian-samudrika-v1.md",
  "21-indian-verbatim-v1.md",
  "30-western-chiromancy-v1.md",
  "31-western-verbatim-v1.md",
...
const MAX_CANON_CHARS = 300_000; // ขยายรับ verbatim ต้นฉบับ 3 สาย (神相全編/Samudrika/Cheiro+Benham ~93K)
...
11. **T1/T2 ก่อน T3 เสมอ (เฉพาะ reading.universal/per_school):** per_school[] จะมีได้ก็ต่อเมื่อ universal[] มีอย่างน้อย 1 รายการ และ T3 รวมต้องไม่ยาวกว่า T1/T2 · **⚠️ กฎ T1-first นี้คุมเฉพาะ "reading.universal"/"reading.per_school" เท่านั้น — "sifu_reading" (A-H) ต้องเจาะเฉพาะบุคคลตามกฎ 27 ไม่ถูกจำกัดด้วย T1-first และห้ามลอกคำ universal มาใส่** · ส่วนคัมภีร์ที่มี source class source-note/bibliographic ให้ทำนายแบบสำรวจ ไม่ฟันธง · Mesopotamian support ใช้ได้เฉพาะเป็น evidence/source_ids เสริมเมื่อ feature นั้นมี T1/T2/T3 หลักอยู่แล้ว
...
19. **ความยาว:** sifu_reading.sections แต่ละข้อให้เขียน seen/meaning/advice อย่างละ 3-5 ประโยค อ่านแล้วต้องรู้สึกเป็นคำทำนายเต็มแบบซินแส ไม่ใช่ bullet สั้น · overview/final_summary ก็ต้องเป็นประโยคเต็ม
...
27. **ห้ามคำอ่านกว้าง/ใช้กับใครก็ได้ (สำคัญมากต่อธุรกิจ · คนอ่านต้องรู้สึกว่า "ใช่มือฉัน"):** sifu_reading ทุก section ต้อง**เจาะเฉพาะมือนี้** — อ่านจากลักษณะที่เห็นจริงและเฉพาะเจาะจง: ความยาว/ความลึก/ความโค้ง/จุดเริ่ม-จบของแต่ละเส้น · เส้นย่อย/เส้นแตก/เกาะ(island)/กากบาท/ดาว/โซ่ · สัดส่วนนิ้ว-นิ้วโป้ง-ข้อนิ้ว · เนินที่นูน/แบน(ดาวพฤหัส/ศุกร์/จันทร์...) · สี/เนื้อมือ/ความแข็ง — แล้วแปลเป็นบุคลิก/พฤติกรรม/จังหวะชีวิตที่เฉพาะคนนี้ · **ห้ามขึ้นต้นทุก section ด้วย "สามสายเห็นร่วมกันว่า..."** (นั่นคือของ reading.universal ไม่ใช่ sifu) · **ห้ามคำแนะนำโหลๆ ที่ใช้กับทุกคน** (ทำบัญชี/จดตาราง/สื่อสารตรงๆ/พักผ่อนให้พอ) เว้นแต่ผูกกับลักษณะเฉพาะที่เห็นจริง · **เกณฑ์ตรวจตัวเอง: ถ้าคำอ่านนั้นเอาไปแปะมือคนอื่นได้โดยไม่ผิด = กว้างเกินไป ต้องเขียนใหม่ให้เจาะ** · field "seen" ต้องบรรยายสิ่งที่ตาเห็นจริงเฉพาะจุด (เช่น "เส้นสมองแตกปลายเป็นง่ามใต้นิ้วนาง") ไม่ใช่ "เส้นหลักชัดเจน" ลอยๆ
28. **grok/vision — สังเกตให้ละเอียดก่อนอ่าน:** ก่อนสรุป ให้ไล่ดูทีละจุด: เส้นหลัก 4 เส้น (จุดเริ่ม-ทิศทาง-ปลาย-ความลึก-รอยแตก/เกาะ) → เส้นรอง (สุริยะ/สุขภาพ/สมรส/ลูก/ความสัมพันธ์) → เนิน 7 เนิน (นูน/แบน) → นิ้ว (ยาว/สั้น/เอียง/ข้อ) → รูปมือ/เนื้อ/สี — เก็บรายละเอียดเฉพาะที่เห็นจริงมาใช้ ยิ่งเจาะยิ่งดี (ห้ามแต่งสิ่งที่ไม่เห็น แต่สิ่งที่เห็นต้องเก็บให้หมด)
29. **บังคับตอบลึก (ไม่ใช่แค่ป้ายชื่อ · หัวใจของเว็บ):** ทุก section ต้องลึกถึงระดับ**พฤติกรรม/สถานการณ์จริงในชีวิต** ไม่ใช่คำกว้างลอยๆ ("คิดเป็นระบบ/มั่นคง/รับผิดชอบ" = ตื้น ห้าม) · โครงบังคับทุก section: (1) "seen" = ลักษณะเฉพาะที่เห็นจริง **≥2 จุด** ระบุว่าเส้นไหน/บริเวณไหน/ยาว-ลึก-โค้ง-แตก-เกาะยังไง (2) "meaning" = เชื่อมเหตุผลเป็นลูกโซ่ "เพราะเห็น[ลักษณะเฉพาะ] ตามคัมภีร์[สาย/รหัส] → คุณเป็นคนที่[บุคลิกเฉพาะ] → ในชีวิตจริงมักจะ[สถานการณ์รูปธรรมที่คนแบบนี้เจอ เช่น ตัดสินใจเรื่องงานแล้วลังเลตอนกลางคัน / เก็บเงินได้แต่ใจอ่อนกับคนใกล้ตัว]" (3) "advice" = ทำได้จริงและผูกกับลักษณะที่เห็น ไม่ใช่คำแนะนำสำเร็จรูป · **ความยาว seen/meaning อย่างละ 3-5 ประโยค** · เขียนแบบซินแสนั่งอ่านตัวต่อตัว มีตัวอย่างสถานการณ์รูปธรรมอย่างน้อย 1 อย่างต่อหัวข้อ ที่ทำให้คนอ่านรู้สึก "ใช่เลย ตรงมาก"
30. **ลึกขึ้นอีกขั้น + สอด "วัยจร" ทุกหัวข้อที่เกี่ยวกับเวลา (เจ้านายเน้นเป็นพิเศษ):** (ก) **ลึกกว่ากฎ 29 อีกระดับ** — แต่ละ section นอกจากบอกบุคลิก ต้องเดินเรื่องต่อว่า "คนที่มือแบบนี้ ในชีวิตจริงมักเดินมาถึงจุดไหน เจอสถานการณ์อะไร เลือกทางไหน" อย่างน้อย 1 ฉากรูปธรรมที่เจ้าตัวน่าจะร้อง "ใช่" ราวกับซินแสรู้จักชีวิตเขา ไม่ใช่บรรยายนิสัยลอยๆ (ข) **วัยจรอ่านจากตำแหน่งบนเส้น (ตามคัมภีร์ Cheiro/Benham — ห้ามเดาปีลอยๆ):** ตำแหน่งบนเส้น = ช่วงวัย — เส้นชีวิตและเส้นวาสนาไล่จาก**ต้นเส้น(ใต้ง่ามนิ้วชี้)=วัยเยาว์ → กลางเส้น=วัยกลางคน → ปลายใกล้ข้อมือ=วัยปลาย** · เส้นวาสนาที่ออกจากเส้นชีวิต = วัยต้นต้องสร้างตัวด้วยลำแข้งตัวเอง [PFA Pg.50] · เกาะ(island)/รอยแตก/เส้นตัด ณ ตำแหน่งใดของเส้น = จังหวะเปลี่ยน/แรงกดดัน/ขาขึ้นของ**ช่วงวัยที่ตำแหน่งนั้นชี้** [PFA Pg.75-76] · **ต้องระบุช่วงวัยลงใน section C(งาน)/D(เงิน)/E(รัก)/G(จุดเปลี่ยน) ด้วยเมื่อเห็นเครื่องหมายชัด** ไม่ใช่พูดวัยจรแค่ section G — เมื่อสัญญาณชัดเจาะเป็นช่วงอายุ/ปีที่เจาะจงได้ (กฎ 20/26) · **timing ต้องอิงตำแหน่งเครื่องหมายบนเส้นจริงเท่านั้น** ไม่มีเครื่องหมายรองรับ = ห้ามยัดปี (ค) **คงข้อห้าม 6 เรื่องเสี่ยง (กฎ 15) เหนือทุกข้อ** — ไม่เจาะวัน/อายุเฉพาะกับ ตาย/อายุขัย/โรคร้าย/แท้ง-มีลูก/หย่า/ภัยพิบัติ
...
═══════════ สคีมา JSON ที่ต้องตอบ ═══════════
{
  ...
  "sifu_reading": {
    ...
    "sections": [
      {"key":"personality","title":"A. พื้นนิสัยและวิธีคิด","seen":"<สิ่งที่เห็นบนมือ 3-5 ประโยค>","meaning":"<ความหมาย 3-5 ประโยค>","advice":"<คำแนะนำ 3-5 ประโยค>","confidence":"high|medium|low","evidence":["<line/feature/canon>"],"source_ids":["HK.PALM.V1.MATRIX.29"],"visible_evidence_count":<number>,"evidence_status":"strong|partial|low","missing_evidence":["<not visible>"]},
      {"key":"energy_stress","title":"B. พลังชีวิตและความเครียด","seen":"<สิ่งที่เห็นบนมือ 3-5 ประโยค>","meaning":"<ความหมาย 3-5 ประโยค>","advice":"<คำแนะนำ 3-5 ประโยค>","confidence":"high|medium|low","evidence":["<line/feature/canon>"],"source_ids":["HK.PALM.V1.MATRIX.30"],"visible_evidence_count":<number>,"evidence_status":"strong|partial|low","missing_evidence":["<not visible>"]},
      {"key":"career","title":"C. งานและเส้นทางอาชีพ","seen":"<สิ่งที่เห็นบนมือ 3-5 ประโยค>","meaning":"<ความหมาย 3-5 ประโยค>","advice":"<คำแนะนำ 3-5 ประโยค>","confidence":"high|medium|low","evidence":["<line/feature/canon>"],"source_ids":["HK.PALM.V1.MATRIX.31"],"visible_evidence_count":<number>,"evidence_status":"strong|partial|low","missing_evidence":["<not visible>"]},
      {"key":"money","title":"D. การเงินและโอกาสทรัพย์","seen":"<สิ่งที่เห็นบนมือ 3-5 ประโยค>","meaning":"<ความหมาย 3-5 ประโยค>","advice":"<คำแนะนำ 3-5 ประโยค>","confidence":"high|medium|low","evidence":["<line/feature/canon>"],"source_ids":["HK.PALM.V1.MATRIX.32"],"visible_evidence_count":<number>,"evidence_status":"strong|partial|low","missing_evidence":["<not visible>"]},
      {"key":"relationship","title":"E. ความรักและความสัมพันธ์","seen":"<สิ่งที่เห็นบนมือ 3-5 ประโยค>","meaning":"<ความหมาย 3-5 ประโยค>","advice":"<คำแนะนำ 3-5 ประโยค>","confidence":"high|medium|low","evidence":["<line/feature/canon>"],"source_ids":["HK.PALM.V1.MATRIX.33"],"visible_evidence_count":<number>,"evidence_status":"strong|partial|low","missing_evidence":["<not visible>"]},
      {"key":"supporters","title":"F. ผู้ใหญ่/บริวาร/คนสนับสนุน","seen":"<สิ่งที่เห็นบนมือ 3-5 ประโยค>","meaning":"<ความหมาย 3-5 ประโยค>","advice":"<คำแนะนำ 3-5 ประโยค>","confidence":"high|medium|low","evidence":["<line/feature/canon>"],"source_ids":["HK.PALM.V1.MATRIX.34"],"visible_evidence_count":<number>,"evidence_status":"strong|partial|low","missing_evidence":["<not visible>"]},
      {"key":"turning_points","title":"G. จุดเปลี่ยนชีวิต","seen":"<สิ่งที่เห็นบนมือ 3-5 ประโยค>","meaning":"<ไล่ช่วงวัยอดีต→ปัจจุบัน→แนวโน้ม แบบช่วงวัยกว้าง 3-5 ประโยค>","timeline":[{"age_range":"<ช่วงวัย เช่น วัยต้นทำงาน 20-27>","event":"<จังหวะที่เห็นจากเส้น>","note":"<อดีต/ปัจจุบัน/แนวโน้ม>"}],"advice":"<คำแนะนำ 3-5 ประโยค>","confidence":"high|medium|low","evidence":["<line/feature/canon>"],"source_ids":["HK.PALM.V1.MATRIX.35"],"visible_evidence_count":<number>,"evidence_status":"strong|partial|low","missing_evidence":["<not visible>"]},
      {"key":"personal_advice","title":"H. คำแนะนำเฉพาะตัว","seen":"<สิ่งที่เห็นบนมือ 3-5 ประโยค>","meaning":"<ความหมาย 3-5 ประโยค>","advice":"<คำแนะนำปฏิบัติได้จริง 3-5 ประโยค>","confidence":"high|medium|low","evidence":["<line/feature/canon>"],"source_ids":["HK.PALM.V1.MATRIX.36"],"visible_evidence_count":<number>,"evidence_status":"strong|partial|low","missing_evidence":["<not visible>"]}
    ],
    "final_summary": {
