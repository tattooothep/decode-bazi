...
export declare function buildZiweiHourlyCopy(locale: string, snapshot: unknown, options?: Readonly<{ schema: 2 | 3; presentationVersion?: string }>): Readonly<{ title: string; body: string }>;
