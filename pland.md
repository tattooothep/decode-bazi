...
| 2026-07-14 | เพิ่มความครบแถบในหน้าและหน้าย่อยเป็นงานถัดไปแบบ strict pixel | Accepted | ดู §29b — จาวิส/UI team รับช่วงในแอพ; ทีม backend ไม่แตะ mobile worktree |
...
## 29b. งานถัดไป: ความครบ "แถบในหน้า + หน้าย่อย" (เจ้าของเคาะ 14 ก.ค. 2026 · "เพิ่มไปใน goal เลยเปนงานถัด strict pixel เหมือนเดิม")

ที่มา: สำรวจโค้ดเว็บจริง 12 หน้า (14 ก.ค.) พบแถบ/โหมดที่แอพยังขาด — ทุกข้อมาตรฐาน strict pixel + VLM เปิดตาเทียบเว็บเหมือนเดิม · 3 ภาษา · 2 ธีม

แถบที่ขาด (เรียงตามหนัก):
1. วางฤกษ์: แถบหมวดภารกิจ 7 (主文談交經宅禮) + ช่วงวัน วันนี้/7วัน/60วัน/กำหนดเอง + เลือกค่ายฉีเหมิน 拆補/置閏 + แผงเปิดปิดโมดูล
2. ฉีเหมิน: ระดับผัง ยาม/วัน/เดือน/ปี (時家/日家/月家/年家) + ค้นหา 2 แบบ (ตามกิจกรรม/ตามองค์ประกอบ) — สำนัก 4 มีแล้วฝั่ง meta ต้อง wire ปุ่มสลับ
3. ดวง: แถบวัยจร 3 โหมด (10 ปี/ปีสำคัญ/ทั้งชีวิต) + ปุ่มขยายก้านซ่อน หลัก/รอง
4. เครือข่าย: แถบในโมดัลดวงรายคน 30 วัน/12 เดือน/ภาพรวมปี
5. หล่อแก: ชิปกรองชั้นศาสตร์ หมวด 1-4 + เปิดหมด/ปิดหมด
6. ปฏิทิน: ตรวจกิจกรรมให้ครบ 15 หมวดตามเว็บ · ราคา: ตารางเทียบ+FAQ · ซินแส: ดูคู่/โหมดกลุ่ม 6 (ตรวจซ้ำ)

หน้าย่อยที่ 12 หน้าลิงก์ออก: ทำก่อน = แก้ข้อมูลเกิด (/input) + เทียบดวง (/comparison) · ไว้ท้าย = /methodology /solar-terms /tianxing · ไฟล์ -m = legacy ถูก redirect ไม่ต้องทำ · /book ไม่มีลิงก์จริงแล้ว
