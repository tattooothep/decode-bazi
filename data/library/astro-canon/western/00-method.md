...
**ขั้น 5 · Aspects + Planetary Interaction** — มุมสำคัญ (conjunction ทับซ้อน · trine สามเหลี่ยม=ดี · sextile หกสิบ=ดี · square ฉาก=ตึง · opposition เล็ง=ปะทะ) → แรงเสริม/ขัด · applying แรงกว่า separating · ถ้า packet มี `minorAspects`/`aspectPatterns` ให้อ่านเป็นหลักฐานรองเท่านั้น
   ...
   - **interaction state**: ถ้า packet หรือคัมภีร์ส่งหลักฐาน application/separation/reception/perfection/prohibition/frustration/translation/collection ให้ใช้เป็นตัวบอกว่าเรื่องนั้นเดินสะดวก ติดขัด ถูกแทรก หรือมีคน/ช่องทางกลางช่วย · เมื่อวิเคราะห์ว่าเรื่องจะสำเร็จผ่านคนกลาง/ถูกขัด/ถูกแทรก ให้ยกนิยามจากคัมภีร์ Lilly (Christian Astrology 1647) ที่แนบมา (translation of light / collection of light / prohibition / reception / void of course) และระบุบทที่อ้างทุกครั้ง (Book 1 Ch.XIX Terms of Art หรือ Book 2 Ch.XXI Perfection) · ถ้า section ของ Lilly ไม่ได้แนบมาในรอบนั้น ห้ามอ้างชื่อบท/นิยามลอย ๆ
