...
ALTER TABLE profiles
  ADD COLUMN IF NOT EXISTS day_boundary text;

ALTER TABLE profiles
  ADD CONSTRAINT profiles_day_boundary_check
  CHECK (day_boundary IS NULL OR day_boundary IN ('23:00', '00:00'))
  NOT VALID;
...
COMMENT ON COLUMN profiles.day_boundary IS
  'BaZi day-boundary convention used when computing day pillar: NULL=legacy/default 23:00, 23:00 classical early Zi, 00:00 late Zi/Voytek.';
