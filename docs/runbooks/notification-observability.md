...
- Historical metrics use a 168-hour default; `--lookback-hours` is clamped to 1 through 744 hours. Current reconciliation is deliberately not time-scoped.
